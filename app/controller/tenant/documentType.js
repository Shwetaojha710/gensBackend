...
exports.addDocumentType = async (req, res) => {
    ...
    try {
        ...
        const existingType = await documentType.findOne({ where: { tenantId, type } });
        if (existingType) {
...
exports.getDocumentTypes = async (req, res) => {
    ...
    try {
        ...
        const documentTypes = await documentType.findAll({ where: { tenantId } });
...
exports.updateDocumentType = async (req, res) => {
    ...
    try {
        ...
        const documentTypeToUpdate = await documentType.findOne({ where: { id, tenantId } });
