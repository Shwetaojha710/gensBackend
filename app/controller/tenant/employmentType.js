...
exports.createHolidayType = async (req, res) => {
    ...
    try {
        ...
        return Helper.response(true, "Holiday Type created successfully", employmentTypeData, res, 201);
    } catch (error) {
        return Helper.response(false, error.message || "Something went wrong", {}, res, 500);
    }
}
exports.getHolidayTypes = async (req, res) => {
    ...
    try {
        ...
        if (name) {
            ...
            return Helper.response(true, "Holiday Type fetched successfully", formatted, res, 200);
        } else {
            ...
            return Helper.response(true, "holiday Types fetched successfully", data, res, 200);
        }
    } catch (error) {
        console.error("Error in getEmploymentTypes:", error);
        return Helper.response(false, error.message || "Something went wrong", [], res, 500);
...
exports.editHolidayType = async (req, res) => {
    ...
    try {
        if (!id || !tenantId) {
            return Helper.response(false, "Holiday Type ID and Tenant ID are required", {}, res, 400);
        }

        const employmentType = await HolidayType.findOne({ where: { id, tenantId } });
        if (!employmentType) {
            return Helper.response(false, "Holiday Type not found", {}, res, 404);
        }
        ...
        return Helper.response(true, "Holiday Type updated successfully", employmentType, res, 200);
    } catch (error) {
        return Helper.response(false, error.message || "Something went wrong", {}, res, 500);
    }
}
...
exports.deleteHolidayType = async (req, res) => {
    ...
    try {
        ...
        return Helper.response(true, "Holiday Type deleted successfully", {}, res, 200);
    } catch (error) {
        return Helper.response(false, error.message || "Something went wrong", {}, res, 500);
    }
}
...
exports.getHolidayTypeDD = async (req, res) => {
    ...
    try {
       if (!tenantId) {
        ...
        return Helper.response(true, "Holiday Types dropdown fetched successfully", formattedEmploymentTypes, res, 200);
    } catch (error) {
